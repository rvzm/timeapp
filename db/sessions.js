...
const stmt = {
  ...
  getSessionUser: db.prepare(`
    SELECT u.id, u.username, u.display_name, u.role, u.email, u.phone, u.job_title, u.employee_number,
           u.break_max_count, u.break_max_minutes, u.theme_color, u.theme_mode, u.theme_background, u.theme_style, s.id AS session_id
...
export const insertSession = ({ id, userId, createdAt, expiresAt }) =>
  stmt.insertSession.run({ id, userId, createdAt, expiresAt });
